...
if ($args -contains "--uninstall") {
    ...
    $cmdScriptPath = "$pwd\poc-gpt-infosec-consultant-runner.cmd"
...
python "$pwd\poc-gpt-infosec-consultant.py"
"@
...
$wtProfileContent = @"
{
    ...
    "hidden": false,
    "name": "poc-gpt-infosec-consultant",
    "commandline": "cmd.exe /k $cmdScriptPath",
    "startingDirectory": "$pwd"
}
"@
$wtProfilePath = "$pwd\poc-gpt-infosec-consultant-wt-profile.json"
...
$shortcutPath = "$env:USERPROFILE\Desktop\poc-gpt-infosec-consultant.lnk"
try {
...
Write-Host "Installation complete. You can now use the poc-gpt-infosec-consultant shortcut from your desktop!"
